...
const Footer = () => {
  ...
  <div>
    <span className="text-2xl font-bold text-accent">Services</span> 
  ...
  <div>
    <span className="text-2xl font-bold text-accent">Company</span> 
  ...
  <div>
    <span className="text-2xl font-bold text-accent">Social</span> 
